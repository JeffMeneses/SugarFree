...
public class FoodMenuActivity extends AppCompatActivity {
    ...
    public void onClickBreakfast(View v)
    {
        ...
        intent.putExtra("mealName", mTxtCard1.getText().toString());
    ...
    {
        Intent intent = new Intent(mContext, MealActivity.class);
        intent.putExtra("mealName", mTxtCard2.getText().toString());
        startActivity(intent);
    }
    ...
    {
        Intent intent = new Intent(mContext, MealActivity.class);
        intent.putExtra("mealName", mTxtCard3.getText().toString());
        startActivity(intent);
    }
    ...
    {
        Intent intent = new Intent(mContext, MealActivity.class);
        intent.putExtra("mealName", mTxtCard4.getText().toString());
        startActivity(intent);
    }
    ...
    {
        Intent intent = new Intent(mContext, MealActivity.class);
        intent.putExtra("mealName", mTxtCard5.getText().toString());
        startActivity(intent);
    }
    ...
    {
        Intent intent = new Intent(mContext, MealActivity.class);
        intent.putExtra("mealName", mTxtCard6.getText().toString());
        startActivity(intent);
    }
}